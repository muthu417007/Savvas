({
    initialize: function(component, event, helper) {
        ...
        //set username based on remember me click 
        if (localStorage.getItem("rememberme")) {
                component.find('rememberMe').set('v.checked',true);
                component.find("username").set("v.value",localStorage.getItem("username"));
            }
    },
    ...
    //show hide password based on eye icon click
