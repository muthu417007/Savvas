...
export default class homeschooltile extends LightningElement {
    @api imageUrl;
    @api variable1;
    @api variable2;
    @api variable3;
    ...
    get imageUrlStyle() {
        return `cursor: pointer; display: table; height: 210px; width: 350px; margin-left: auto; margin-right: auto; background: url("${this.imageUrl}"); background-repeat: no-repeat;background-size: 90%; background-position: center;`;
      }

      get fontLargeStyle() {
        if (this.fontColor === undefined) {
          if (this.fontLarge === undefined) {
            return `display: table-cell; vertical-align: middle;padding-left: 50px; padding-top: 20px; font-size: 20px!important; color: white!important;`;
          } else {
            return `display: table-cell; vertical-align: middle;padding-left: 60px; font-size: ${this.fontLarge}px!important; color: white!important;`;
          }
        } else if (this.fontLarge === undefined) {
          return `display: table-cell; vertical-align: middle;padding-left: 50px; font-size: 14px!important; color: ${this.fontColor}!important;`;
        } else {
          return `display: table-cell; vertical-align: middle;padding-left: 50px; font-size: ${this.fontLarge}px!important; color: ${this.fontColor}!important;`;
        }
      }
