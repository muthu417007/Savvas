...
//         // Check if the input value contains the 'e' character
//         if (value.includes('e')) {
//             // If 'e' character is found, prevent its entry and display error message
//             errorMessage.style.display = 'block';
//             input.setCustomValidity("Please enter only numeric characters."); // Set custom validity
//         } else {
