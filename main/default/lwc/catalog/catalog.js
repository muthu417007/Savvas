            ...
            .then((result) => {
                ...
                if (prodIds.length > 0) {
                    ...
                    getProductDetails({ prodId: prodIds })
                        ...
                        const updateEvent = new CustomEvent('productdataupdate', { detail: { productData: this.productData } }); this.dispatchEvent(updateEvent);
 ...
 ********************************************************/
    openChildTitlePage(event) {
      //  console.log('hi helo');
       ...
       console.log('hi helo1',JSON.stringify(getdatafromchild));
       ...
       // const plainObject = Object.assign({}, selectedProductRecord);
console.log('hi helo2', JSON.stringify(selectedProductRecord, null, 2));
...
//       const closeBtn= this.template.querySelector(".Catalog");
//       closeBtn.focus();
