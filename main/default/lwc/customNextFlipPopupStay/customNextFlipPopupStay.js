...
export default class CustomNextFlipPopupStay extends LightningElement {
    @api imageUrl;
    @api variable1;
    @api variable2;
    @api variable3;
    ...
    get imageUrlStyle() {
        return `display: table;height: 150px;width: 300px;margin-left: auto;margin-right: auto;padding-left: 20px; padding-right: 20px; background: url(${this.imageUrl}); background-size: 100%; z-index: -1; border-radius: 3px;`;
      }
