...
export default class scc_catalogLWC extends LightningElement {
    ...
    connectedCallback() {
        this.template.host.style.setProperty('--spinner-dot-color', 'blue');
    }
 connectedCallback() {
        this.template.querySelector('lightning-tree').classList.add('custom-tree');
    }
