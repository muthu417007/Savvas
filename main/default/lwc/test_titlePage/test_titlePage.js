...
export default class Test_titlePage extends LightningElement {
    // Properties
...
onselected(event) {
        ...
        console.log('After assigning new value to the api variable',this.parentSelectedProductRecord);
