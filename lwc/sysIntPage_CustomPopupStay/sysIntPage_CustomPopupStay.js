...
export default class SysIntPage_CustomPopupStay extends LightningElement {
    @api imageUrl;
    @api variable1;
    @api variable2;
    @api variable3;
    ...
    get CardStyle(){
      ...
      return `display: table;text-align: left; height:190px;width: 380px;margin-left: auto;margin-right: auto; background-repeat: no-repeat;background-size: 90%; background-position: Fit;z-index: -1; border-radius: 3px;`;
		}

    get imageUrlStyle() {
        return `display: table;text-align: left; height:190px;width: 380px;margin-left: auto;margin-right: auto; background: url(${this.imageUrl});background-repeat: no-repeat;background-size: 100%; background-position: Fit;z-index: -1; border-radius: 3px;`;
      }
     get imageUrlStyleback() {
        return `display: table; text-align: left; height:180px;width: 360px;margin-left: auto;margin-right: auto;background-size: 100%; z-index: -1; border-radius: 3px;`;
      }
      get fontLargeStyle() {
      ...
      handleGoNext() {
          ...
          //if (this.availableActions.find(action => action === 'NEXT')) {
            ...
            // this version does not navigate to the next screen
