...
export default class sysIntPage_JustTile extends LightningElement {
    @api imageUrl;
    @api variable1;
    @api variable2;
    @api variable3;
    ...
    get imageUrlStyle() {
        return `cursor: pointer; display: table; height: 200px; width: 400px; margin-left: auto; margin-right: auto; background: url("${this.imageUrl}"); background-repeat: no-repeat;background-size: 90%; background-position: center;`;
      }
      ...
      get fontLargeStyle() {
        if (this.fontColor === undefined) {
          if (this.fontLarge === undefined) {
            return `display: table-cell; vertical-align: middle;white-space: pre-wrap; font-size: 24px!important; color: white!important;`;
          } else {
