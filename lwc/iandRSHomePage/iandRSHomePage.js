...
export default class CustomNext extends LightningElement {
    @api imageUrl;
    @api variable1;
    @api variable2;
    @api variable3;
    ...
    get imageUrlStyle() {
        return `cursor: pointer; display: table; height: 210px; width: 550px; margin-left: auto; margin-right: auto; background: url("${this.imageUrl}"); background-repeat: no-repeat;background-size: 90%; background-position: center;`;
      }

      get fontLargeStyle() {
        if (this.fontColor === undefined) {
          if (this.fontLarge === undefined) {
            return `display: table-cell; vertical-align: middle;padding-left: 70px; font-size: 36px!important; color: white!important;`;
          } else {
          ...
          return `display: table-cell; vertical-align: middle;padding-left: 50px; font-size: 24px!important; color: ${this.fontColor}!important;`;
        } else {
