...
export default class CustomNextFade extends LightningElement {
    @api imageUrl;
    @api variable1;
    @api variable2;
    @api variable3;
      ...
      get fontLargeStyle() {
        if (this.fontColor === undefined) {
          if (this.fontLarge === undefined) {
            return `display: table-cell; vertical-align: middle; font-size: 24px!important; color: white;`;
          } else {
            return `display: table-cell; vertical-align: middle; font-size: ${this.fontLarge}px; color: white!important;`;
          }
        } else if (this.fontLarge === undefined) {
          return `display: table-cell; vertical-align: middle; font-size: 24px!important; color: ${this.fontColor};`;
        } else {
          return `display: table-cell; vertical-align: middle; font-size: ${this.fontLarge}px!important; color: ${this.fontColor};`;
        }
      }
